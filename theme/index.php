...
<div id="content_area" class="clearfix">
  ...
  <div id="container" class="clearfix">
    <div id="content" class="clearfix">
      <div class="aktuelles"><?php _e('Aktuelles aus dem Chapter') ?></div>
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>

          <div id="news_post" class="clearfix">
            <div id="news_title"><a href="<?php the_permalink() ?>">
                <div class="main_title"><?php the_title(); ?></div><br />
                <div class="sub_title"><?php the_excerpt(); ?></div>
              </a></div>
    ...
    <a href="/news-archive" class="archive_link"><?php _e('Zum Archiv') ?></a>
  </div>
</div>
