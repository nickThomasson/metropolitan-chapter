...
<?php
					...
					if( have_rows('officer') ):

						// loop through the rows of data
						while ( have_rows('officer') ) : the_row();
							$image = get_sub_field('officer_photo');
							...
							<div class="member-item">
									<?php if( $image ) { ?>
										<a href="<?php echo $imagesrc[0]; ?>" title="<?php the_sub_field('officer_name'); ?>">
										<?php echo wp_get_attachment_image( $image, $size ); ?>
										</a>
									<?php }  ?>
								
										<div class="member-name"><h3><?php the_sub_field('officer_name'); ?><br><?php the_sub_field('officer_lastname'); ?></h3></div>
										<div class="member-position"><h5><?php the_sub_field('officer_position'); ?></h5></div>
